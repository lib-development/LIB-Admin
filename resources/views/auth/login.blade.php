    ...
    <div class="animatedParent">
        <div class="row">
            <div class="container" style="text-align: center; display: flex;">
                <div class="col-xs-12 col-md-4 col-sm-6 col-lg-4 col-md-offset-5" style="margin: 0 auto;">
                    <div class="signup-box">
                        <div class="logo"><img src="{{ url('/img/favicon.png') }}" style="height: 50px;" alt=""></div>
                        <button id="googleAuth" type="button" class="google-button">
