...
@section('script')
    ...
    <script>
        new FroalaEditor('#my-editor-froala', {
            imageUploadURL: '/file/upload?type=image',
            videoUploadURL: '/file/upload?type=video'
        });
    </script>
...
//                $('textarea#my-editor').val();
        ...
        //     // extraPlugins: 'video,html5video,tableresize,uploadimage,uploadfile,sourcearea,iframe,clipboard,pastebase64,base64image,basicstyles',
