...
<head>
    ...
    <meta name="description"
        content="News, Events, Entertainment, Lifestyle, Fashion, Beauty, Inspiration and yes... Gossip! *Wink">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ url('/assets/plugins/bootstrap/bootstrap.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ url('/assets/plugins/monthly/css/monthly.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ url('/assets/plugins/emojionearea/emojionearea.min.css') }}">

    <link rel="stylesheet" type="text/css"
        href="{{ url('assets/plugins/date-picker/css/bootstrap-datepicker3.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ url('assets/plugins/dateTime-picker/css/bootstrap-datetimepicker.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ url('assets/plugins/customselect/customselect.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ url('assets/plugins/select2/css/select2.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ url('assets/plugins/jasny-bootstrap/css/jasny-bootstrap.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ url('assets/plugins/emojionearea/emojionearea.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ url('assets/plugins/timepicker/bootstrap-timepicker.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ url('assets/plugins/colorpicker/css/bootstrap-colorpicker.min.css') }}">
...
<body>
        ...
        <header class="header-top navbar fixed-top">
            ...
            <div class="collapse navbar-collapse" id="headerNavbarCollapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a> <span
                                class="btn btn-primary btn-xs">{{ auth()->user()->type_u->name }}</span></a>
                    </li>
                    ...
                    <li class="user-profile dropdown">
                        <a href="javascript:;" class="clearfix dropdown-toggle"
                        ...
                        <ul class="dropdown-menu dropdown-animated pop-effect" role="menu">
                            ...
                            <li><a href="{{ url('/logout') }}"><i class="sli-logout"></i> Logout</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="has-submenu">
                        ...
                        <div class="sub-menu collapse in secondary" id="submenuOne">
                            <ul>
                                ...
                                <li><a href="{{ url('/posts') }}">Posts ({{ article_all() }})</a>
                                </li>
                                <li><a href="{{ url('/posts/approval/pending') }}">Pending Approval
                                        ({{ article('2') }})</a></li>
                                ...
                                <li><a href="{{ url('/posts/draft') }}">Draft
                                        ({{ article('3') }})</a></li>
                                @if(auth()->user()->user_type_id == "1")
                                <li><a href="{{ url('/post/schedule') }}">Scheduled Post
                                        ({{ article('4') }})</a></li>
                                @endif
                            </ul>
                        </div>
                    ...
                    <li class="has-submenu">
                        ...
                        <div class="sub-menu collapse secondary" id="submenuFour">
                            <ul>
                                ...
                                <li><a href="{{ url('/comments/moderation') }}">Awaiting
                                        Moderation</a></li>
                                @if(auth()->user()->email == "williamnwogbo@gmail.com" ||
                                auth()->user()->email =="lindaikejisblog.com")
    ...
    <script data-cfasync="false" type="text/javascript"
        src="{{ url('/assets/plugins/lib/jquery-2.2.4.min.js') }}"></script>
    <script data-cfasync="false" type="text/javascript"
        src="{{ url('/assets/plugins/lib/jquery-ui.min.js') }}"></script>
    <script data-cfasync="false" type="text/javascript"
        src="{{ url('/assets/plugins/bootstrap/bootstrap.min.js') }}"></script>
    <script data-cfasync="false" type="text/javascript"
        src="{{ url('/assets/plugins/lib/plugins.js') }}"></script>


    <script data-cfasync="false" type="text/javascript"
        src="{{ url('assets/plugins/date-picker/js/bootstrap-datepicker.min.js') }}"></script>
    <script data-cfasync="false" type="text/javascript"
        src="{{ url('assets/plugins/dateTime-picker/js/bootstrap-datetimepicker.min.js') }}">
    </script>
    <script data-cfasync="false" type="text/javascript"
        src="{{ url('assets/plugins/customselect/jquery.customselect.js') }}"></script>
    <script data-cfasync="false" type="text/javascript"
        src="{{ url('assets/plugins/select2/js/select2.min.js') }}"></script>
    <script data-cfasync="false" type="text/javascript"
        src="{{ url('assets/plugins/jasny-bootstrap/js/jasny-bootstrap.min.js') }}"></script>
    <script data-cfasync="false" type="text/javascript"
        src="{{ url('assets/plugins/lib/characterCounter.min.js') }}"></script>
    <script data-cfasync="false" type="text/javascript"
        src="{{ url('assets/plugins/emojionearea/emojionearea.min.js') }}"></script>
    <script data-cfasync="false" type="text/javascript"
        src="{{ url('assets/plugins/timepicker/bootstrap-timepicker.min.js') }}"></script>
    <script data-cfasync="false" type="text/javascript"
        src="{{ url('assets/plugins/colorpicker/js/bootstrap-colorpicker.min.js') }}"></script>


    <script data-cfasync="false" type="text/javascript"
        src="{{ url('/assets/plugins/flot/excanvas.min.js') }}"></script>

    <script data-cfasync="false" type="text/javascript"
        src="{{ url('/assets/plugins/lib/sparklines.js') }}"></script>
    <script data-cfasync="false" type="text/javascript"
        src="{{ url('/assets/plugins/lib/jquery.knob.min.js') }}"></script>
    <script data-cfasync="false" type="text/javascript"
        src="{{ url('/assets/plugins/monthly/js/monthly.js') }}"></script>
    <script data-cfasync="false" type="text/javascript"
        src="{{ url('/assets/plugins/emojionearea/emojionearea.min.js') }}"></script>

    <script data-cfasync="false" type="text/javascript" src="{{ url('/assets/js/app.base.js') }}">
    </script>
    <script data-cfasync="false" type="text/javascript" src="{{ url('/assets/js/cmp-todo.js') }}">
    </script>
    <script data-cfasync="false" type="text/javascript"
        src="{{ url('/assets/js/page-dashboard.js') }}"></script>
