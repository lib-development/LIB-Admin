                    ...
                    <form method="POST" action="{{ url('/categories') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" required class="form-control"
                                id="header_arti" placeholder="Category Name">
                        </div>
                        <div class="form-group">
                            <label for="name">Description</label>
                            <input type="text" name="description" data-role="tagsinput" required
                                class="form-control" id="header_arti"
                ...
                <div class="modal-body">
                    <form method="POST" id="editForm" action="{{ url('/categories') }}">
                        ...
                        <div class="form-group">
                            <label for="name">Name</label>
                            <input type="text" name="name" required class="form-control"
                                id="editName" placeholder="Category Name">
                        </div>
                        <div class="form-group">
                            <label for="name">Description</label>
                            <input type="text" name="description" data-role="tagsinput" required
                        ...
                        <h3 class="panel-title">Categories
                            <span>
                                <a href="javascript:;" style="margin-left: 10px;"
                                    ...
                                    data-target="#myModal">Add New Category</a>
                            </span>
                        </h3>
                    </div>
                                    ...
                                    <table class="table table-responsive">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 300px">URL on Blog</th>
                                                <th>Author</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a target="_blank"
                                                        href="{{ env('APP_BLOG_DOMAIN') }}/{{ $category->slug }}">{{ env('APP_BLOG_DOMAIN') . '/'.$category->slug }}</a>
                                                </td>
                                                ...
                                                <td>
                                                    <p>
                                                        @if (isset($category->owner))
                                                            @if (auth()->user()->user_type_id == "1")
                                                                <a
                                                                href="{{ url('/profile/view/' . encrypt_decrypt('encrypt', $category->owner->id )) }}">{{ $category->owner->name }}</a>
                                                            @else
