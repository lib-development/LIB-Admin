                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <ul class="list-flow-info">
                                ...
                                <li class="col-xs-3 text-info">
                                    <h3>Pending</h3>
                                    <h4>{{ $pending_c }}</h4>
                                </li>
                                <li class="col-xs-3 text-success">
                                    <h3>Published</h3>
                                    <h4>{{ $published_c }}</h4>
                                </li>
                            </ul>
                                    ...
                                    <ul class="list-supportTickets">
                                        @if(count($articles))
                                            @foreach($articles as $article)
                                                <li>
                                                    <a href="{{ url('/post/edit/'.encrypt_decrypt('encrypt',$article->id)) }}"><img src="
                                <?php
                                                    ...
                                                    <div class="ticket-details" style="margin-left: 45px;">
                                                        <h4><a href="{{ url('/post/edit/'.encrypt_decrypt('encrypt',$article->id)) }}">{{ $article->title }} @if($article->status == "1")
